...
scope.NODE = true;
console.log("Building bytebuffer-node with scope");
fs.writeFileSync(
...
console.log("Building bytebuffer.js with scope");
fs.writeFileSync(
...
scope.NODE = false;
scope.DATAVIEW = true;
console.log("Building bytebuffer-dataview with scope");
fs.writeFileSync(
...
console.log("Updating bower.json with scope");
fs.writeFileSync(
